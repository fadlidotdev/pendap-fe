...
export default function WriteLetter({ open, onClose, handleSubmit }) {
  ...
  return (
    <div className="px-4 fixed z-50 bottom-0 left-0 right-0 lg:w-full lg:max-w-lg lg:left-[unset]">
      <div className="shadow-2xl px-4 pt-4 pb-2 bg-indigo-50 rounded-tl-lg rounded-tr-lg overflow-hidden">
        <div className="flex items-center justify-between bg-indigo-100 -mx-4 px-4 -mt-4 py-2  mb-2">
          <header className="font-medium text-gray-900">
            Kirim Surat Baru
          </header>
